					...
					<div class="tabs clearfix">
						...
						<div id="tab-module-<?php echo $module_row; ?>" class="tab-content">
							<table class="form" style="margin-bottom:10px">
							  <tr>
							    <td style="border:none;padding-top:7px">类型:</td>
							    <td style="border:none;padding-top:7px"><select name="custom_module_module[<?php echo $module_row; ?>][type]" class="select-type" id="<?php echo $module_row; ?>">
							    	...
							    	<option value="1" selected="selected">区块</option>
							    	<?php } else { ?>
							    	<option value="1">区块</option>
							    	<?php } ?>
							...
							<div id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
							  ...
							  <div class="html<?php echo $module_row; ?>" <?php if (2 != $module['type']) { echo 'style="display:none"'; } ?>>
								  <table class="form">
								    <tr>
								      <td>HTML:</td>
								      <td><textarea rows="0" cols="0" name="custom_module_module[<?php echo $module_row; ?>][html][<?php echo $language['language_id']; ?>]" id="html-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>"><?php echo isset($module['html'][$language['language_id']]) ? $module['html'][$language['language_id']] : ''; ?></textarea></td>
								    </tr>
								  </table>
							  </div>
							</div>
...
function addModule() {	
	html  = '<div id="tab-module-' + module_row + '" class="tab-content">';
		...
		html += '		<tr>';
		html += '			<td style="border:none;padding-top:7px">类型:</td>';
	...
	$('#html-'+module_row+'<?php echo "-".$language["language_id"]; ?>').summernote({height: 300});
	module_row++;
}
//--></script> 
  <script type="text/javascript"><!--
...
foreach($modules as $module){
			...
			?>
			$('#html-<?php echo $module_row."-".$language["language_id"]; ?>').summernote({height: 300});
			<?php
			}
	$module_row++;
	}?>
