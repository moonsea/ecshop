				...
				<div>
					<div class="tabs clearfix">
						...
						<div id="tabs" class="htabs main-tabs">
							...
							<a href="#tab-module-<?php echo $module_row; ?>" id="module-<?php echo $module_row; ?>">模组 <?php echo $module_row; ?> &nbsp;<img src="view/image/module_template/delete-slider.png"  alt="" onclick="$('.vtabs a:first').trigger('click'); $('#module-<?php echo $module_row; ?>').remove(); $('#tab-module-<?php echo $module_row; ?>').remove(); return false;" /></a>
							<?php $module_row++; ?>
							<?php } ?>
							<span id="module-add">添加模组 &nbsp;<img src="view/image/module_template/add.png" alt="" onclick="addModule();" /></span>
						</div>
										...
										<tr>
											...
											<td style="width:430px">
												<select name="filter_product_module[<?php echo $module_row; ?>][tabs][<?php echo $element; ?>][title]" title="<?php echo $module_row; ?>_<?php echo $element; ?>" class="get_product_from">
													<option value="latest"<?php if($tab['title'] == 'latest') { echo ' selected="selected"'; } ?>>最新商品</option>
													<option value="special"<?php if($tab['title'] == 'special') { echo ' selected="selected"'; } ?>>特色商品 </option>
													<option value="bestsellers"<?php if($tab['title'] == 'bestsellers') { echo ' selected="selected"'; } ?>>畅销商品</option>
													<option value="products"<?php if($tab['title'] == 'products') { echo ' selected="selected"'; } ?>>选择商品</option>
													<option value="category"<?php if($tab['title'] == 'category') { echo ' selected="selected"'; } ?>>选择分类</option>
												</select>
												...
												<div class="filter_product_module_<?php echo $module_row; ?>_<?php echo $element; ?>_products panel-products-autocomplete"<?php if($tab['title'] != 'products') { echo ' style="display:none"'; } ?>>
													<div class="products-autocomplete clearfix">
														<p>商品:<br><span style="font-size:11px;color:#808080">(自动完成)</span></p>
												...
												<div class="filter_product_module_<?php echo $module_row; ?>_<?php echo $element; ?>_categories panel-categories-autocomplete"<?php if($tab['title'] != 'category') { echo ' style="display:none"'; } ?>>
													<div class="products-autocomplete clearfix">
														<p>分类:<br><span style="font-size:11px;color:#808080">(自动完成)</span></p>
...
function addModule() {	
	...
	html += '    </tr>';
	html += '    <tr>';
	html += '      <td>最大列数 - 最大行数 - 某类别最大读取条数:</td>';
...
function addTabs(module_row) {
	...
	html += '			<option value="latest">最新商品</option>';
	html += '			<option value="special">特色商品</option>';
	html += '			<option value="bestsellers">畅销商品</option>';
	html += '			<option value="products">选择商品</option>';
	html += '			<option value="category">选择分类</option>';
	html += '		</select>';
	...
	html += '				<p>商品:<br><span style="font-size:11px;color:#808080">(自动)</span></p>';
	...
	html += '			<div class="products-autocomplete clearfix">';
	html += '				<p>分类:<br><span style="font-size:11px;color:#808080">(Autocomplete)</span></p>';
	...
	html += '		</div>';
	html += '    </td>';
	html += '    <td><a onclick="$(\'#module-tabs-' + module_row + '-' + element + '\').remove();">移除</a></td>';
	html += '  </tr>';
	html += '</tbody>';
