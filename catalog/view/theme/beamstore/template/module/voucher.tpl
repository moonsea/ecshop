<div class="panel panel-default" style="margin-bottom: 10px">
  ...
  <div id="collapse-voucher" class="panel-collapse collapse">
    <div class="panel-body">
      <label class="col-sm-3 control-label" for="input-voucher" style="padding: 12px 20px 7px 0px"><?php echo $entry_voucher; ?></label>
...
$('#button-voucher').on('click', function() {
  $.ajax({
    ...
    success: function(json) {
      ...
      if (json['error']) {
        $('.center-column > form').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
