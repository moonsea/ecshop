...
(1, 'admin', 'admin@admin.com', 'bd7985571cc41443a5a0a80a58aba410', '3204', 1460530945, 1461123274, '127.0.0.1', 'all', '商品列表|goods.php?act=list,订单列表|order.php?act=list,用户评论|comment_manage.php?act=list,会员列表|users.php?act=list,商店设置|shop_config.php?act=list_edit', '', 1, 0, NULL, NULL, '13151', '526436525', '45726527', '6275'),
...
('e9aeb82f474705328ee2c1ee3d4c411a', 1461223141, 0, 0, '127.0.0.1', '0', 0, 0.00, '0', 'a:0:{}');
