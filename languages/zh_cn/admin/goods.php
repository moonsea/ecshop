...
//-- 商品列表
/*------------------------------------------------------ */
$_LANG['is_textvr'] = '开启竖排文字';
$_LANG['is_format'] = '开启版式';
$_LANG['is_mask'] = '开启蒙版';
$_LANG['is_border'] = '开启边框';
$_LANG['is_gif'] = '开启剪贴画';
$_LANG['is_background'] = '开启背景';
$_LANG['is_pic'] = '开启用户图片';
$_LANG['is_text_on'] = '开启文本';
$_LANG['album_is_hard'] = '硬壳';
$_LANG['album_is_soft'] = '软壳';
$_LANG['album_is_leather'] = '皮革';
$_LANG['gray_is_on'] = '启用';
$_LANG['pic_is_zero'] = 'jpg';
$_LANG['pic_is_not_zero'] = 'png';
$_LANG['is_zero'] = '单页';
$_LANG['is_not_zero'] = '跨页';
...
$_LANG['lab_goods_other_parameter'] = '其他参数：(单位：mm)';
$_LANG['lab_goods_safe_line'] = '安全线：(单位：mm)';
$_LANG['lab_goods_blood_h'] = '普通页水平出血：';
$_LANG['lab_goods_blood_v'] = '普通页垂直出血：';
$_LANG['lab_goods_blood'] = '出血：(单位：mm)';
$_LANG['lab_goods_inner_width'] = '内页设计宽度：';
$_LANG['lab_goods_inner_height'] = '内页设计高度：';
$_LANG['lab_goods_size'] = '尺寸:(单位：mm)';
$_LANG['lab_goods_defination'] = '分辨率:(单位：像素/英寸)';
$_LANG['lab_goods_line_min'] = '最小行距:';
$_LANG['lab_goods_line_max'] = '最大行距:';
$_LANG['lab_goods_line_up_unit'] = '行距递增单位:';
$_LANG['lab_goods_font_size'] = '字号和行距设置:';
$_LANG['lab_goods_material'] = '功能素材:';
$_LANG['lab_goods_add_page_unit'] = '加页单位:';
$_LANG['lab_goods_add_page_max'] = '最大页数:';
$_LANG['lab_goods_add_page_start'] = '起始页数:';
$_LANG['lab_goods_price_add_page'] = '加页价格:';
$_LANG['lab_goods_album'] = '画册选项:';
$_LANG['lab_goods_composite_pdf'] = '合并为pdf:';
$_LANG['lab_goods_gray'] = '灰度特效:';
$_LANG['lab_goods_composite_pic'] = '合成图片格式：';
$_LANG['lab_goods_composite_page'] = '合成图片格式：';
$_LANG['lab_bind_type'] = '装订类型：';
$_LANG['lab_select_custom'] = '自定义';
...
$_LANG['lab_shop_price'] = '实际销售价：';
$_LANG['lab_market_price'] = '市场参考价：';
$_LANG['lab_market_price_unit'] = '元  仅供消费者购买此商品时参考的市场零售价，一般可以得比当前零售价高一些';
...
$_LANG['notice_goods_gray'] = '适用于内雕水晶等单色商品';
...
$_LANG['notice_give_integral'] = '买满××元可以得××积分等更多促销方案，请到“促销方案管理”中设置';
$_LANG['notice_give_integral_desc_1'] = '购买一件此商品可以得到';
$_LANG['notice_give_integral_desc_2'] = '积分 ';
