...
<li><a onclick="addOptionGroup()" href="#tab-option-group" data-toggle="tab"><?php echo $tab_option_group; ?></a></li>
...
-->
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                               <td class="text-left"><select onchange='updateNewLabelValue("<?php echo $option_row; ?>");' name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control option_select">
...
var $option_group_row=<?php echo $option_group_row;?>;
...
function addOptionValue(option_row,item_type) {	
	html  = '<tr id="option-value-row' + option_value_row + '">';
	html += '  <td class="text-left"><select onchange=updateNewLabelValue("'+option_row+'"); name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value_id]" class="form-control option_select">';
	...
	$('#option-value' + option_row + ' tbody').append(html);
        $('[rel=tooltip]').tooltip();
updateNewLabelValue(option_row);
