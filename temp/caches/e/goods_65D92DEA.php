<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:79:"D:/Codes/Project/Server/PHPnow/htdocs/ecshop/themes/ecmoban_meilishuo/goods.dwt";i:1;s:93:"D:/Codes/Project/Server/PHPnow/htdocs/ecshop/themes/ecmoban_meilishuo/library/page_header.lbi";i:2;s:93:"D:/Codes/Project/Server/PHPnow/htdocs/ecshop/themes/ecmoban_meilishuo/library/page_footer.lbi";}s:7:"expires";i:1460778183;s:8:"maketime";i:1460774583;}<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<title>高质感毛呢大衣_衬衫_女装_ECSHOP模板堂（www.ecmoban.com）专业ECSHOP模板制作 ECSHOP模板定制_ECSHOP模板修改_ECSHOP模板出售_ECSHOP模板案例</title>
...
<div class="cover-img" style="background-image:url(images/201410/goods_img/141_G_1413926445159.jpg); margin-top:20px; margin-bottom:20px;"></div>
<center>
	<h1>《高质感毛呢大衣》</h1>
    <p class="f16">作者：空格</p>
    	...
    	<ul class="list-group">
        	<li class="list-unstyled mt-20 mb-20 text-center height-auto">
                ...
                <div class="col-lg-10 col-md-10 col-sm-10 col-xs-10 height-auto" style="border-bottom:2px solid #ccc; padding-bottom:30px;">
                                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mb-5 img" style="background:url(images/201410/goods_img/141_P_1413926538102.jpg) center center no-repeat; background-size:cover; border:5px solid #fff;">
                    </div>
                                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mb-5 img" style="background:url(images/201410/goods_img/141_P_1413926445875.jpg) center center no-repeat; background-size:cover; border:5px solid #fff;">
                    </div>
                                	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 mb-5 img" style="background:url(images/201410/goods_img/141_P_1413926538993.jpg) center center no-repeat; background-size:cover; border:5px solid #fff;">
                    </div>
                                <!--
