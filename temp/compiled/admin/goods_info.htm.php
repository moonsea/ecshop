...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        ...
        class="tab-back" id="gallery-tab"><?php echo $this->_var['lang']['tab_gallery']; ?></span><?php if ($this->_var['goods_type_list']): ?><span
    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <!-- 点击数 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_click_count']; ?></td>
          ...
          <tr>
            ...
            <td><input type="checkbox" name="is_new" value="1" <?php if ($this->_var['goods']['is_new']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_new']; ?> <input type="checkbox" name="is_hot" value="1" <?php if ($this->_var['goods']['is_hot']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_hot']; ?> <input type="checkbox" name="is_best" value="1" <?php if ($this->_var['goods']['is_best']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_best']; ?> <input type="checkbox" name="is_promote" value="1" <?php if ($this->_var['goods']['is_promote']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_promote']; ?></td>
          </tr>
          <!-- 装订类型 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_bind_type']; ?></td>
            <td><select name="goods_bind_type" onchange="hideCatDiv()"><?php echo $this->_var['bind_type_list']; ?><option value="0"><?php echo $this->_var['lang']['lab_select_custom']; ?></option></select></td>
          </tr>
          <!-- 销售操作 -->
          <tr id="alone_sale_1">
          ...
          <tr>
            ...
            <td><input type="text" name="market_price" value="<?php echo $this->_var['goods']['market_price']; ?>" size="20" /><span class="notice-span"><?php echo $this->_var['lang']['lab_market_price_unit']; ?></span>
            </td>
          </tr>
          <!-- 实际销售价 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_shop_price']; ?></td>
            <td><select name="cat_id" onchange="hideCatDiv()" ><?php echo $this->_var['cat_list']; ?><option value="0"><?php echo $this->_var['lang']['lab_select_custom']; ?></option></select></td><br/>
            <td><input type="text" name="shop_price" value="<?php echo $this->_var['goods']['shop_price']; ?>" size="20" onblur="priceSetted()"/></td>
          </tr>
          <!-- 赠送积分 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_give_integral']; ?></td>
            <td>
              <span class="notice-span"><?php echo $this->_var['lang']['notice_give_integral_desc_1']; ?></span>
              <input type="text" name="give_integral" value="<?php echo $this->_var['goods']['give_integral']; ?>" size="20" />
              <span class="notice-span"><?php echo $this->_var['lang']['notice_give_integral_desc_2']; ?></span>
              <br/>
              <span class="notice-span" id="giveIntegral"><?php echo $this->_var['lang']['notice_give_integral']; ?></span>
            </td>
          </tr>
...
?>
        ...
        <table width="90%" id="properties-table" style="display:none" align="center">
          ...
          <!-- 合成图片格式 -->
          <tr>
              <td class="label"><?php echo $this->_var['lang']['lab_goods_composite_page']; ?></td>
              <td><input type="radio" name="is_zero" value="0" <?php if (! $this->_var['goods']['goods_composite_page']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_zero']; ?> <input type="radio" name="is_zero" value="1" /><?php echo $this->_var['lang']['is_not_zero']; ?></td>
              </td>
          </tr>
          <!-- 合成图片格式 -->
          <tr>
              <td class="label"><?php echo $this->_var['lang']['lab_goods_composite_pic']; ?></td>
              <td><input type="radio" name="pic_is_zero" value="0" <?php if (! $this->_var['goods']['goods_composite_pic']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['pic_is_zero']; ?> <input type="radio" name="is_zero" value="1" /><?php echo $this->_var['lang']['pic_is_not_zero']; ?></td>
              </td>
          </tr>
          <!-- 灰度特效 -->
          <tr>
              <td class="label"><?php echo $this->_var['lang']['lab_goods_gray']; ?></td>
              <td><input type="radio" name="gray_is_on" value="1" <?php if ($this->_var['goods']['goods_gray']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['gray_is_on']; ?>&nbsp;&nbsp;&nbsp;&nbsp;
              <span class="notice-span"><?php echo $this->_var['lang']['notice_goods_gray']; ?></span></td>
              </td>
          </tr>
          <!-- 合并为pdf -->
          <tr>
              <td class="label"><?php echo $this->_var['lang']['lab_goods_composite_pdf']; ?></td>
              <td><input type="radio" name="pdf_is_on" value="1" <?php if ($this->_var['goods']['goods_composite_pdf']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['pdf_is_on']; ?>
              </td>
          </tr>
          <!-- 画册选项 -->
          <tr>
              <td class="label"><?php echo $this->_var['lang']['lab_goods_album']; ?></td>
              <td><input type="radio" name="album_type" value="0" <?php if (! $this->_var['goods']['goods_album']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['album_is_soft']; ?><input type="radio" name="album_type" value="1" <?php if (( $this->_var['goods']['goods_album'] == 1 )): ?> checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['album_is_hard']; ?><input type="radio" name="album_type" value="2" <?php if (( $this->_var['goods']['goods_album'] == 2 )): ?> checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['album_is_leather']; ?></td>
              </td>
          </tr>
          <!-- 加页价格 -->
          <tr>
              <td class="label"><?php echo $this->_var['lang']['lab_goods_price_add_page']; ?></td>
              <td id="goods_price_add_page">
            <?php echo $this->_var['lang']['lab_goods_add_page_start']; ?>
            <!-- <input type="hidden" name="temp_tpagestart"> -->
            <select name="tpagestart" id="goods_add_page_start">
            ...
            <?php echo $this->_var['lang']['lab_goods_add_page_max']; ?>
            <!-- <input type="hidden" name="temp_tpagemax" value="32"> -->
            <select name="tpagemax">
            <option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option><option value="49">49</option><option value="50">50</option><option value="51">51</option><option value="52">52</option><option value="53">53</option><option value="54">54</option><option value="55">55</option><option value="56">56</option><option value="57">57</option><option value="58">58</option><option value="59">59</option><option value="60">60</option><option value="61">61</option><option value="62">62</option><option value="63">63</option><option value="64">64</option><option value="65">65</option><option value="66">66</option><option value="67">67</option><option value="68">68</option><option value="69">69</option><option value="70">70</option><option value="71">71</option><option value="72">72</option><option value="73">73</option><option value="74">74</option><option value="75">75</option><option value="76">76</option><option value="77">77</option><option value="78">78</option><option value="79">79</option><option value="80">80</option><option value="81">81</option><option value="82">82</option><option value="83">83</option><option value="84">84</option><option value="85">85</option><option value="86">86</option><option value="87">87</option><option value="88">88</option><option value="89">89</option><option value="90">90</option><option value="91">91</option><option value="92">92</option><option value="93">93</option><option value="94">94</option><option value="95">95</option><option value="96">96</option><option value="97">97</option><option value="98">98</option><option value="99">99</option></select>
            <?php echo $this->_var['lang']['lab_goods_add_page_unit']; ?>
            <!-- <input type="hidden" name="temp_tpageaddunit" value="4"> -->
            <select name="tpageaddunit">
          ...
          <!-- 功能素材 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_material']; ?></td>
            <td><input type="checkbox" name="is_text_on" value="1" <?php if ($this->_var['goods']['is_text_on']): ?> checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_text_on']; ?> <input type="checkbox" name="is_pic" value="1" <?php if ($this->_var['goods']['is_pic']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_pic']; ?> <input type="checkbox" name="is_background" value="1" <?php if ($this->_var['goods']['is_background']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_background']; ?> <input type="checkbox" name="is_gif" value="1" <?php if ($this->_var['goods']['is_gif']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_gif']; ?><input type="checkbox" name="is_border" value="1" <?php if ($this->_var['goods']['is_border']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_border']; ?><input type="checkbox" name="is_mask" value="1" <?php if ($this->_var['goods']['is_mask']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_mask']; ?><input type="checkbox" name="is_format" value="1" <?php if ($this->_var['goods']['is_format']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_format']; ?><input type="checkbox" name="is_textvr" value="1" <?php if ($this->_var['goods']['is_textvr']): ?>checked="checked"<?php endif; ?> /><?php echo $this->_var['lang']['is_textvr']; ?></td>
          </tr>
          <!-- 字号和行距设置 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_font_size']; ?></td>
            <td><span class="notice-span"><?php echo $this->_var['lang']['lab_goods_line_min']; ?></span><input type="text" name="goods_line_min" value="<?php echo $this->_var['goods']['goods_line_min']; ?>" size="20" /><span class="notice-span"><?php echo $this->_var['lang']['lab_goods_line_max']; ?></span><input type="text" name="goods_line_max" value="<?php echo $this->_var['goods']['goods_line_max']; ?>" size="20" /><span class="notice-span"><?php echo $this->_var['lang']['lab_goods_line_up_unit']; ?></span><input type="text" name="goods_line_up_unit" value="<?php echo $this->_var['goods']['goods_line_up_unit']; ?>" size="20" />
            </td>
          </tr>
          <!-- 分辨率 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_defination']; ?></td>
            <td><input type="text" name="goods_defination" value="<?php echo $this->_var['goods']['goods_defination']; ?>" size="20" /></td>
          </tr>
          <!-- 尺寸 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_size']; ?></td>
            <td><span class="notice-span"><?php echo $this->_var['lang']['lab_goods_inner_width']; ?></span><input type="text" name="goods_inner_width" value="<?php echo $this->_var['goods']['goods_inner_width']; ?>" size="20" /><span class="notice-span"><?php echo $this->_var['lang']['lab_goods_inner_height']; ?></span><input type="text" name="goods_inner_height" value="<?php echo $this->_var['goods']['goods_inner_height']; ?>" size="20" />
            </td>
          </tr>
          <!-- 出血 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_blood']; ?></td>
            <td><span class="notice-span"><?php echo $this->_var['lang']['lab_goods_blood_h']; ?></span><input type="text" name="goods_blood_h" value="<?php echo $this->_var['goods']['goods_blood_h']; ?>" size="20" /><span class="notice-span"><?php echo $this->_var['lang']['lab_goods_blood_v']; ?></span><input type="text" name="lab_goods_blood_v" value="<?php echo $this->_var['goods']['lab_goods_blood_v']; ?>" size="20" />
            </td>
          </tr>
          <!-- 安全线 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_safe_line']; ?></td>
            <td><input type="text" name="goods_safe_line" value="<?php echo $this->_var['goods']['goods_safe_line']; ?>" size="20" />
            </td>
          </tr>
          <!-- 其他参数 -->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_goods_other_parameter']; ?></td>
            <td><input type="text" name="goods_safe_line" value="<?php echo $this->_var['goods']['goods_safe_line']; ?>" size="20" />
            </td>
          </tr>
          <tr>
...
<script language="JavaScript">
  ...
  var temp = "<select>";
  var temp = <?php echo $this->_var['lang']['lab_goods_add_page_start']; ?> + temp;

  var temp = "";
  for(var i=1; i<100; i++)
  {
    temp += "<option value="+i+" i>"+i+"</option>";
  }
  // temp += "</select>";
  //alert(temp);
  //$("#num").html(temp);
  document.getElementById("goods_add_page_start").innerHTML = temp;
  document.getElementById("goods_add_page_max").innerHTML = temp;
  document.getElementById("goods_add_page_unit").innerHTML = temp;
