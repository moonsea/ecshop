...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><?php echo $this->_var['lang']['goods_click_count']; ?></th>
    <!-- <th><?php echo $this->_var['lang']['shop_price']; ?></th> -->
...
?>
  <tr>
    ...
    <!-- 点击数 -->
    <td align="center"><?php echo $this->_var['goods']['click_count']; ?></td>
    ...
    <td align="center">
      ...
      <a href="javascript:;" onclick="listTable.remove(<?php echo $this->_var['goods']['goods_id']; ?>, '<?php echo $this->_var['lang']['drop_goods_confirm']; ?>', 'drop_goods')"><?php echo $this->_var['lang']['drop_complete']; ?></a>
    </td>
  </tr>
  <?php endforeach; else: ?>
