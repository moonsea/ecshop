    ...
    <tr>
      <td height="201" align="center" ><table width="328" height="180">
          ...
          <tr>
            ...
            <td colspan="2"><input type="password" name="password" style=" width:218px; line-height:24px; padding:0; height:24px; background:url(images/txtbg.png) no-repeat; border:none; padding:0px 3px;" /></td>
          </tr>
